...
namespace StaffHabit.Api.Migrations.Application
{
    ...
    [Migration("20250624132336_Habit collections mnodified")]
    partial class Habitcollectionsmnodified
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StaffHabit.Api.Entities.HabitTag", b =>
                {
                    ...
                    b.ToTable("habit_tags", "staff_dev");
                });

            modelBuilder.Entity("StaffHabit.Api.Entities.Tag", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
            ...
            modelBuilder.Entity("StaffHabit.Api.Entities.HabitTag", b =>
                {
                    b.HasOne("StaffHabit.Api.Entities.Habit", null)
                        .WithMany("HabitTags")
                        .HasForeignKey("HabitId")
                    ...
                    b.HasOne("StaffHabit.Api.Entities.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
